...
describe('Login Page - excercise 4', () => {
  //nemuzu sem natahnout login udaje (konstanty promenne) pro vsechny testy, protoze se stranka teprve bude nacitat viz. dole browser.reloadSession, browser.url..... takze se to natahne do testu (do it), ale neni stranka jeste nactena, pod beforeEach to take nelze dat, budeme se to ucit v dalsi lekci, jak to udelat
